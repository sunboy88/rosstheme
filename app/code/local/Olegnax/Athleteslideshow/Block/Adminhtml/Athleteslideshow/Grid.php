...
class Olegnax_Athleteslideshow_Block_Adminhtml_Athleteslideshow_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('athleteslideshowGrid');
  ...
  {
      $collection = Mage::getModel('athleteslideshow/athleteslideshow')->getCollection();
  ...
  protected function _prepareColumns()
  {
	  ...
	  $this->addColumn('image', array(
          ...
          'align'     =>'left',
          'index'     => 'image',
		  'renderer' => 'athleteslideshow/adminhtml_athleteslideshow_grid_renderer_image'
      ));
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('athleteslideshow');
