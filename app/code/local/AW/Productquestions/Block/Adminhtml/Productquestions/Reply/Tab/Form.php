...
class AW_Productquestions_Block_Adminhtml_Productquestions_Reply_Tab_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField('question_status', 'select', array(
            ...
            'values' => AW_Productquestions_Model_Source_Question_Status::toOptionArray(),
        ));
