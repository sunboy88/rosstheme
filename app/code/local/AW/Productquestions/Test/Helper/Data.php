...
class AW_Productquestions_Test_Helper_Data extends EcomDev_PHPUnit_Test_Case {
    ...
    public function isModuleOutputDisabled() {
        Mage::app()->getStore()->setConfig('advanced/modules_disable_output/AW_Productquestions', true);
        $this->assertEquals(true, $this->_data->isModuleOutputDisabled());
        Mage::app()->getStore()->setConfig('advanced/modules_disable_output/AW_Productquestions', false);
    ...
    public function isAdvancedNewsletterInstalled() {
        ...
        $check = array_key_exists('AW_Advancednewsletter', $modules)
