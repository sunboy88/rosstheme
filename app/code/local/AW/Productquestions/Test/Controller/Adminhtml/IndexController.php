...
class AW_Productquestions_Test_Controller_Adminhtml_IndexController extends EcomDev_PHPUnit_Test_Case_Controller {
    ...
    public function saveAction($data) {
        ...
        Mage::app()->getStore(1)->setConfig(AW_Productquestions_Model_Source_Config_Path::EMAIL_SENDER, $data['sender']);
