...
*/
class Belvg_MultipleWishlist_Block_Frontend_Popup_Content extends Mage_Core_Block_Template
{

    public function getTabs ()
    {
        $wishlist = Mage::getModel('multiplewishlist/tab')->getWishlist();
        ...
        return Mage::helper('multiplewishlist')->prepareTabs($tabs);
    }
}