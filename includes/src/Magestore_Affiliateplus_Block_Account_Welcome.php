<?php
class Magestore_Affiliateplus_Block_Account_Welcome extends Mage_Core_Block_Template
{
	public function getPageIdentifier(){
		return Mage::helper('affiliateplus/config')->getGeneralConfig('welcome_page');
	}
