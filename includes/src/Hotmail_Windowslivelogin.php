...
class Hotmail_Windowslivelogin
{
    ...
    {
        $o = new Hotmail_Windowslivelogin();
    ...
    public static function initFromArray($settings)
    {
        $o = new Hotmail_Windowslivelogin();
    ...
    public function processToken($token, $context=null)
    {
        ...
        try {
            $user = new Hotmail_Wll_User(@$parsedToken['ts'], 
                                 @$parsedToken['uid'], 
                                 @$parsedToken['flags'], 
                                 $context, $token);
        } catch (Exception $e) {
    ...
    public function processConsentToken($token, $context=null)
    {
        ...
        try {
            $consenttoken = new Hotmail_Wll_Consenttoken($this,
                                                @$parsedToken['delt'], 
                                                @$parsedToken['reft'], 
                                                @$parsedToken['skey'], 
                                                @$parsedToken['exp'], 
