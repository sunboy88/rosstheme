...
*/
class Belvg_MultipleWishlist_Block_Adminhtml_Customer_Edit_Tab_Renderer_Name extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{

    public function render (Varien_Object $row)
    {
        return $row->getData('wishlist_name');
    }
}