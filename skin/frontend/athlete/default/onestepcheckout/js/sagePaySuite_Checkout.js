...
getOneStepCheckoutId = function() {
    ...
    var possibleIds = [{form:"onestepcheckout-form", trigger:"onestepcheckout-place-order"},{form:"onepagecheckout_orderform", trigger:".button.btn-checkout"},{form:"one-step-checkout-form", trigger:"onestepcheckout-button-place-order"}];
...
//            }
            ...
            //IWD_OnePage
            //@TODO: Fix quote save data error
...
/*One Step Checkout with Sagepay */
...
reviewSave: function(transport){
    ...
    if((typeof transport.responseText) == 'undefined' && $(window._sagepayonepageFormId)){
        ...
        /* One Step Checkout Magestore with sagepay*/
        disable_payment();
